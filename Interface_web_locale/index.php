...
<body class="total_background">
	...
	<div class=" w-75 p-3 mx-auto tableau_background tableau_bordure" id="contenu1"> 
		...
		<h5 class="text-primary border-bottom border-primary" style="padding-bottom:5 ;"><i class="fas fa-bolt"></i>  Tableau de bord
			...
			foreach ($locaux as $local){
				...
				<h6 class="font-weight-bold pt-4 "  data-compteur="<?= $compteur; ?>" >
					<!--Nom du local-->
					<p  class="text-dark appui curseur bouton" id="titre<?= $compteur;?>" data-compteur="<?= $compteur; ?>">
					<?= $local ?>
						<!--Icone triangle-->
	...
	<div style="display:none"  class="w-75 p-3 mx-auto tableau_bordure tableau_background container_2" id="contenu2">
			...
			<div class="responsive_circle">
				...
				<!--Faire glisser le choix-->
				<div class="slidecontainer">
  					<input type="range" min="0" max="24" value="8" class="slider" id="myRange" >
  					<input type="range" min="0" max="24" value="8" class="slider" id="myRange2" >
  					</br>

  					<span id="demo" class="centrer text-primary case"></span>
  					<span id="demo2" class="centrer2 text-primary case2"></span>
  				</div>

				<h7 class="matin hour_example" id="label_pourcent">0h à 8h</h7>
				<h7 class="aprem hour_example" id="label_pourcent2">8h à 16h</h7>
				<h7 class="soir hour_example"  id="label_pourcent3">16h à 24h</h7>
				<!--Pour le matin-->
				<div id="matin" class="circle"><i class="fas fa-cloud-sun h3 text-primary text_example day"></i>
					<!--Affichage du pourcentage-->
					<p class="h4 chiffre_matin  chiffre_pos text_example" id="pourcent">
					<?= $matin." %" ;?>
					</p>
				</div>
				<!--Pour le midi-->
				<div id="midi" class="circle"><i class="far fa-sun h3 text-primary text_example day"></i>
					<!--Affichage du pourcentage--> 
					<p class="h4 chiffre_midi chiffre_pos text_example" id="pourcent2">
					<?= $midi." %" ;?>
					</p>
				</div>
				<!--Pour le soir-->
				<div id="soir" class="circle"> <i class="far fa-moon h3 text-primary text_example day"></i>
					<!--Affichage du pourcentage-->
					<p class="h4 chiffre_soir  chiffre_pos text_example" id="pourcent3">
					<?= $soir." %" ;?>
					</p>
				</div>
			</div>
